...
import 'package:doctor_mobile/modules/patients/features/reservations/controllers/1_select_doctor_controller.dart';
...
class SelectDoctorView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(SelectDoctorController());
    return Scaffold(
      appBar: AppBar(
